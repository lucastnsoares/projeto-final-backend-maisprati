...
public record AdminPostResponseDTO(
        ...
        @Schema(description = "Indica se o artigo foi excluído ou não", example = "false")
        Boolean isDeleted,

        @Schema(description = "Data de exclusão do registro, se aplicável", example = "2026-08-27T00:00:00Z")
        Instant deletedAt,

        @Schema(description = "Nome do usuário que excluiu o conteúdo, se aplicável", example = "Maria Oliveira")
    ...
    public AdminPostResponseDTO(Post post) {
        this(
                ...
                post.isPublished(),
                post.getDeletedAt() != null ? true : false,
                post.getDeletedAt(),
